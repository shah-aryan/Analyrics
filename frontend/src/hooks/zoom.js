  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth <= 350) {
        ...
        document.documentElement.style.height = '140%'; // Compensate for the scale
        ...
        document.documentElement.style.height = '125%'; // Compensate for the scale
        ...
        document.documentElement.style.height = '111.11%'; // Compensate for the scale
      } else {
