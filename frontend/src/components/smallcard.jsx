...
const SmallCard = ({ number, label, icon, showPlus = true }) => {
  return (
    <div className="relative bg-base-200 flex flex-col items-center p-2 rounded-3xl outline outline-1 outline-base-300 hover:bg-opacity-80 transition duration-300 h-full">
