...
import StackedAreaChart from './sentimentsds3.jsx';
  ...
  return (
    <div className="flex p-4">
      ...
      <div className="flex-grow pl-4 ">
        <div className="bg-base-200 rounded-lg shadow-lg outline outline-1 outline-base-300" style={{ height: '300px', width: '400px' }}>
